...
3. Generate a comprehensive list of all surnames found in the images
...
- For the surnames list: Only output surnames
- For the places list: List of all countries found in the images.  For United States, list only states.
